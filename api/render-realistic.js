// Realistic AI rendering endpoint using Stable Interiors V2
// Updated: 2026-03-08 - Using youzu/stable-interiors-v2 for fast interior design rendering (~7-10 seconds)
    ...
    const response = await fetch('https://api.replicate.com/v1/predictions', {
      ...
      body: JSON.stringify({
        ...
        input: {
          ...
          num_inference_steps: 18,  // Optimal for quality/speed balance
